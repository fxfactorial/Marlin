 ...
 */
  ...
  //#define  Y_SLAVE_ADDRESS 0 // 2 in kersey but why (both commented out but changed)
  //#define  Z_SLAVE_ADDRESS 0 // 1 in kersey but why 
  ...
  //#define E0_SLAVE_ADDRESS 0 // 3 in kersey but why (also commented out but changed)
